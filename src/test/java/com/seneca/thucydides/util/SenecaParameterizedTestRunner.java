...
public class SenecaParameterizedTestRunner extends Suite {
    ...
    private class TestClassRunnerForParameters extends SenecaThucydidesRunner {
        ...
        private Object createTestUsingConstructorInjection() throws Exception {
        	//System.out.println("fParameters---->"+getTestClass().getOnlyConstructor().newInstance(fParameters).getClass().getSimpleName());
        ...
        protected String testName(FrameworkMethod method) {
        	// System.out.println(" method.getName() + getName()"+method.getName() + getName());

...
//Changed version on 0.9.201 version
/**
 ...
 * @author johnsmart
 */
public class SenecaThucydidesRunner extends BlockJUnit4ClassRunner {
    ...
    private final Logger logger = LoggerFactory.getLogger(SenecaThucydidesRunner.class);
     ...
     */
    public SenecaThucydidesRunner(final Class<?> klass) throws InitializationError {
        this(klass, Injectors.getInjector());
    }
    
    public SenecaThucydidesRunner(Class<?> klass, Module module) throws InitializationError {
    	this(klass, Injectors.getInjector(module));
	}

    public SenecaThucydidesRunner(final Class<?> klass,
    ...
    public SenecaThucydidesRunner(final Class<?> klass, final BatchManager batchManager) throws InitializationError {
        this(klass,

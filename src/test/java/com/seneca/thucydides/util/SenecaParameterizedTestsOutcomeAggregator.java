...
public class SenecaParameterizedTestsOutcomeAggregator {
    private final SenecaThucydidesParameterizedRunner senecaThucydidesParameterizedRunner;

    private SenecaParameterizedTestsOutcomeAggregator(SenecaThucydidesParameterizedRunner senecaThucydidesParameterizedRunner) {
        this.senecaThucydidesParameterizedRunner = senecaThucydidesParameterizedRunner;
    }

    public static SenecaParameterizedTestsOutcomeAggregator from(SenecaThucydidesParameterizedRunner senecaThucydidesParameterizedRunner) {
        return new SenecaParameterizedTestsOutcomeAggregator(senecaThucydidesParameterizedRunner);
    }
    ...
    public List<TestOutcome> getTestOutcomesForAllParameterSets() {
        ...
        testOutcomes.addAll(((ThucydidesRunner) senecaThucydidesParameterizedRunner.getRunners().get(0)).getTestOutcomes());
        for (Runner runner : senecaThucydidesParameterizedRunner.getRunners()) {
